...
/// <summary>
/// 针对 <see cref="Nerosoft.Euonia.Caching.Runtime.RuntimeCacheService"/> 的测试。
/// </summary>
public class RuntimeCacheServiceTest
{
	private readonly ICacheService _service;

	public RuntimeCacheServiceTest(ICacheService service)
	{
		_service = service;
	}
